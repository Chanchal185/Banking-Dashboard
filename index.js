...
function withdraw() {
    let inputAmount = parseFloat(document.getElementById("withdrawalInput").value);
    let balance = parseFloat(document.getElementById("balance").innerHTML);
    ...
    if (inputAmount > balance) {
        alert(`Insufficient funds. Your current balance is $${balance.toFixed(2)}. Please enter an amount less than or equal to your current balance.`);
        return;
    }
